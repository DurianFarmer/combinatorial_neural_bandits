...
experiment(Neural, "TS", h1, n_features=80, hidden_size=60, save='reg_h1_CNTS(M=1)_80_60')


# In[ ]:


experiment(Neural, "TS", h1, n_features=80, hidden_size=60, n_samples=10, save='reg_h1_CNTS_80_60')