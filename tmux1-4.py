...
experiment(Neural, "UCB", h4, n_features=80, hidden_size=60, save='reg_h4_CNUCB_80_60')


# In[ ]:


experiment(Neural, "TS", h4, n_features=80, hidden_size=60, save='reg_h4_CNTS(M=1)_80_60')


# In[ ]:


experiment(Neural, "TS", h4, n_features=80, hidden_size=60, n_samples=10, save='reg_h4_CNTS_80_60')
