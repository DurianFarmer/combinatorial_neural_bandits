...
experiment(Neural, "TS", h3, n_features=80, hidden_size=60, save='reg_h3_CNTS(M=1)_80_60')


# In[ ]:


experiment(Neural, "TS", h3, n_features=80, hidden_size=60, n_samples=10, save='reg_h3_CNTS_80_60')
